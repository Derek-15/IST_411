...
function getDailyAPI() {
    return __awaiter(this, void 0, void 0, function () {
        var apiString, dailyValue, response, jsonData, responseText;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    apiString = "https://www.alphavantage.co/query";
                    dailyValue = document.getElementById("dss").value;
                    //apistring
                ...
                case 2:
                    jsonData = _a.sent();
                    responseText = "Opening: " + (jsonData["Global Quote"]["02. open"]) + "<br>" +
    ...
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    apiString = "https://www.alphavantage.co/query";
                    dailyValue = document.getElementById("oss").value;
                    //apistring
                ...
                case 2:
                    jsonData = _a.sent();
                    responseText = "Name: " + (jsonData['Name']) +
